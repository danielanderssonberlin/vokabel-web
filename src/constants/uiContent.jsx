...
export const UI_STRINGS = {
  de: {
    COMMON: {
      ...
      PREDEFINED_LANGUAGES: [
        { code: 'en', name: 'Englisch', flag: '🇬🇧', example: 'apple' },
        { code: 'es', name: 'Spanisch', flag: '🇪🇸', example: 'manzana' },
        { code: 'fr', name: 'Französisch', flag: '🇫🇷', example: 'pomme' },
        { code: 'it', name: 'Italienisch', flag: '🇮🇹', example: 'mela' },
        { code: 'pt', name: 'Portugiesisch', flag: '🇵🇹', example: 'maçã' },
        { code: 'ru', name: 'Russisch', flag: '🇷🇺', example: 'яблоко' },
        { code: 'tr', name: 'Türkisch', flag: '🇹🇷', example: 'elma' },
        { code: 'pl', name: 'Polnisch', flag: '🇵🇱', example: 'jabłko' },
        { code: 'nl', name: 'Niederländisch', flag: '🇳🇱', example: 'appel' },
      ],
    },
    LANDING: {
    ...
    LEARNING: {
      ...
      SESSION_STATS_PRACTICED: "Gelernt",
      SESSION_STATS_FINISHED: "Abgeschlossen",
      SESSION_STATS_KNOWN: "Gewusst",
      EMPTY_STATE: "Alle Vokabeln sind im Archiv oder du hast noch keine hinzugefügt.",
      NEW_SESSION: "Neue Session",
      REFRESH: "Aktualisieren",
      ARCHIVE_REPEAT: "Archiv wiederholen (Random)",
      ARCHIVE_MODAL_TITLE: "Archiv wiederholen",
      ARCHIVE_OPTION_RANDOM: "Zufällige 20",
      ARCHIVE_OPTION_LAST_50: "Letzte 50",
      ARCHIVE_OPTION_ALL: "Letzte 100",
      ERRORS_OVERVIEW: "Deine Fehler im Überblick",
      USER_ANSWER: "Deine Antwort",
      ...
      INPUT_PLACEHOLDER_LAST_PASS: "Bitte tippen (letzter Durchlauf)...",
    ...
    OVERVIEW: {
      ...
      ARCHIVE_REPEAT: "Archiv wiederholen",
      ...
      VERB_TYPE_LABEL: "Anzeige-Modus",
      VERB_TYPE_CONJUGATION: "Konjugation (yo, tú...)",
      VERB_TYPE_3FORMS: "3 Zeitformen (bring, brought...)",
      ...
      FORM_PAST_SIMPLE: "Simple Past",
      FORM_PAST_PARTICIPLE: "Past Participle",
      CONJUGATED_LABEL: "(konjugiert)",
      YO: "yo",
      TU: "tú",
      EL: "él/ella",
      NOSOTROS: "nosotros",
    ...
    PROFILE: {
      ...
      AUTO_PROCEED_LABEL: "Automatisch weiter",
      AUTO_PROCEED_DESC: "Geht bei richtiger Antwort automatisch zur nächsten Vokabel",
  ...
  en: {
    COMMON: {
      ...
      PREDEFINED_LANGUAGES: [
        { code: 'en', name: 'English', flag: '🇬🇧', example: 'apple' },
        { code: 'es', name: 'Spanish', flag: '🇪🇸', example: 'manzana' },
        { code: 'fr', name: 'French', flag: '🇫🇷', example: 'pomme' },
        { code: 'it', name: 'Italian', flag: '🇮🇹', example: 'mela' },
        { code: 'pt', name: 'Portuguese', flag: '🇵🇹', example: 'maçã' },
        { code: 'ru', name: 'Russian', flag: '🇷🇺', example: 'яблоко' },
        { code: 'tr', name: 'Turkish', flag: '🇹🇷', example: 'elma' },
        { code: 'pl', name: 'Polish', flag: '🇵🇱', example: 'jabłko' },
        { code: 'nl', name: 'Dutch', flag: '🇳🇱', example: 'appel' },
      ],
    },
    LANDING: {
    ...
    LEARNING: {
      ...
      SESSION_STATS_PRACTICED: "Practiced",
      SESSION_STATS_FINISHED: "Finished",
      SESSION_STATS_KNOWN: "Known",
      EMPTY_STATE: "All words are in the archive or you haven't added any yet.",
      NEW_SESSION: "New Session",
      REFRESH: "Refresh",
      ARCHIVE_REPEAT: "Review Archive (Random)",
      ARCHIVE_MODAL_TITLE: "Review Archive",
      ARCHIVE_OPTION_RANDOM: "Random 20",
      ARCHIVE_OPTION_LAST_50: "Last 50",
      ARCHIVE_OPTION_ALL: "Last 100",
      ...
      INPUT_PLACEHOLDER_LAST_PASS: "Please type (final pass)...",
    ...
    OVERVIEW: {
      ...
      VERB_TYPE_LABEL: "Display Mode",
      VERB_TYPE_CONJUGATION: "Conjugation (I, you...)",
      VERB_TYPE_3FORMS: "3 Tenses (bring, brought...)",
    ...
    PROFILE: {
      ...
      AUTO_PROCEED_LABEL: "Auto proceed",
      AUTO_PROCEED_DESC: "Automatically goes to the next vocabulary on correct answer",
